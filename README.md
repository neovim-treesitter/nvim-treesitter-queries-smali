# nvim-treesitter-queries-smali

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-smali/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-smali/actions/workflows/validate.yml)

Neovim tree-sitter queries for **smali**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-smali",
...
- [ ] Changes are scoped to `smali` — do not include files for other languages
